...
- Over 75 banters with 1205 lines (approx) with Bioware NPCs.
- Over 446 interjections with 975 lines (approx).
- Over 30 banters with over 650 lines (approx) between the 2 NPCs (these were the figures for the Beta, which are less than for the SoA Release).
- 3 banters for both Kova and Kiyone with the Player.
- Interjections for Watcher's Keep.
- Original sound set for Kiyone - also has FEMALE4 sound set voicing in an optional component.
- Original sound set for Kova.
- 2 BGMs for the banters.
...
Beyond the Law for Windows is distributed as an extractable compressed archive and includes a WeiDU installer.
...
**Q: I think I messed up a segment of the BTL quest. Will I still be able to play the other parts?**  
...
**Q: I've handled the quest well (I think) but nothing happens between them?**  
